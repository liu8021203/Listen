...
public final class StrUtil {
    ...
    /**
     * 验证身份证方式(true为正确的身份证格式，false为错误的格式);
     **/
     ...
     * 处理url图片
     **/
    public static String getHTMLdATE(String htmlDate) {
        htmlDate = htmlDate.replaceAll("&", "");
        htmlDate = htmlDate.replaceAll("quot;", "\"");
        htmlDate = htmlDate.replaceAll("lt;", "<");
        return htmlDate = htmlDate.replaceAll("gt;", ">");
    }
    ...
    public static String toDate(int lastUpdate) {

        Long timestamp = Long.parseLong(String.valueOf(lastUpdate))*1000;
    ...
    public static String toMDate(int lastUpdate) {
//
//        Date dat = new Date(lastUpdate);
//        GregorianCalendar gc = new GregorianCalendar();
//        gc.setTime(dat);

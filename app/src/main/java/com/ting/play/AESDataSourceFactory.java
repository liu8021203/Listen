...
public class AESDataSourceFactory implements DataSource.Factory {
     ...
     */
    public AESDataSourceFactory(Context context, String userAgent) {
     ...
     */
    public AESDataSourceFactory(Context context, TransferListener<? super DataSource> listener,
    ...
    public AESDataSource createDataSource() {
        return new AESDataSource(context, listener, baseDataSourceFactory.createDataSource());
    }
}

...
public class SlidingMenu extends RelativeLayout {
    ...
    public void setCenterView(View view) {
        ...
        // R.drawable.shade_bg));
        bgParams.addRule(RelativeLayout.ALIGN_PARENT_RIGHT, RelativeLayout.TRUE);
    ...
    public void showRightView() {
        ...
        if (oldScrollX == 0) {
            ...
            if (cannotClickView != null) {
                cannotClickView.setVisibility(View.VISIBLE);
            }
            ...
            if (cannotClickView != null) {
                cannotClickView.setVisibility(View.INVISIBLE);
            }
        }
    }
    ...
    public void setCannotClickView(View cannotClickView) {
        this.cannotClickView = cannotClickView;
    }

    public View getCannotClickView() {
        return cannotClickView;
    }

...
public class ScrollBaseListView extends ListView implements OnScrollListener {
     ...
     * @param context
     */
    public ScrollBaseListView(Context context) {
        super(context);
        initWithContext(context);
    }

    public ScrollBaseListView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initWithContext(context);
    }

    public ScrollBaseListView(Context context, AttributeSet attrs, int defStyle) {

...
public class CycleViewPager extends Fragment implements OnPageChangeListener {
    ...
    public void setData(List<ImageView> views, List<Slider> list, ImageCycleViewListener listener) {
     ...
     */
    public void setData(List<ImageView> views, List<Slider> list, ImageCycleViewListener listener, int showPosition) {
        ...
        paramsone.leftMargin = UtilPixelTransfrom.px2dip(this.getActivity().getApplicationContext(), 20);//
        ...
        for (int i = 0; i < indicators.length; i++) {
            ...
            indicatorLayout.addView(view, paramsone);
        }
    ...
    private void setIndicator(int selectedPosition) {
        for (int i = 0; i < indicators.length; i++) {
            indicators[i]
                    .setBackgroundResource(R.mipmap.white_radio);
        }
        if (indicators.length > selectedPosition)
            indicators[selectedPosition]
                    .setBackgroundResource(R.mipmap.blue_radio);
    }
    ...
    public static interface ImageCycleViewListener {
         ...
         * @param imageView
         */
        public void onImageClick(Slider info, int postion, View imageView);
    }
}
...
#--------------------听世界----------------------
-keep class com.ting.play.subview.PlayListSubView$ViewWrapper{*;}
...
-keep class com.umeng.socialize.net.utils.**{*;}
...
-keep public class * extends io.reactivex.observers.DisposableObserver
